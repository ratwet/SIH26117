...
async def chat_sync(request: ChatRequest):
    ...
    return {
        ...
        "stl_path": final_state.get("stl_path"),
...
async def chat_stream(
    ...
    async def event_generator():
        ...
        completion_payload = {
            ...
            "pdf_path": final_state.get("pdf_path") if final_state else None,
            "cad_path": final_state.get("cad_path") if final_state else None,
            "stl_path": final_state.get("stl_path") if final_state else None,
            "image_path": final_state.get("image_path") if final_state else None,
            "csv_path": final_state.get("csv_path") if final_state else None,
